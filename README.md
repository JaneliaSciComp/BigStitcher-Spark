...
* `FAST_ROTATION` is a rotation invariant method and can find corresponding constellation of points even if they are significantly rotated relative to each other. 
* `FAST_TRANSLATION`
* `PRECISE_TRANSLATION`
* `ICP`
