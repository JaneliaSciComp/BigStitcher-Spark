...
You can open the ZARR in Fiji (`File > Import > HDF5/N5/ZARR/OME-NGFF`or `Plugins > BigDataViewer > HDF5/N5/ZARR/OME-NGFF`) or by using `n5-view` in the [n5-utils package](https://github.com/saalfeldlab/n5-utils).
