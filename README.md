...
You can open the ZARR for example in [Fiji](https://fiji.sc) (`File > Import > HDF5/N5/ZARR/OME-NGFF`or `Plugins > BigDataViewer > HDF5/N5/ZARR/OME-NGFF`), using `n5-view` in the [n5-utils package](https://github.com/saalfeldlab/n5-utils) (`./n5-view -i /Users/preibischs/SparkTest/Stitching/fused.zarr -d /ch0`) or in [Napari](https://napari.org/stable/).
