...
public class BlendingRealRandomAccess2 extends RealPoint implements RealRandomAccess< FloatType >
{
	 ...
	 */
	public BlendingRealRandomAccess2(
			final Interval interval,
			final float[] border,
	...
	{
		final BlendingRealRandomAccess2 r = new BlendingRealRandomAccess2( interval, border, blending );
		r.setPosition( this );
		return r;
	}
	...
	public static void main( String[] args )
	{
		...
		final BlendingRealRandomAccess2 blend = new BlendingRealRandomAccess2(
